...
@section('css')
    ...
    <style>
        ...
        ul.cate-content > li:last-child {
            border-bottom: none;
        }

        ul.cate-content > li > ul {
            padding-left: 20px;
            display: none;
        }

        ul.cate-content > li > ul.show {
            display: block;
        }

        ul.cate-content > li > ul a {
            margin-bottom: 3px;
        }

        ul.cate-content > li > a {
            margin-bottom: 5px;
            color: #202124;
            font-weight: 600;
        }

        ul.cate-content > li .linkrss {
            color: -webkit-link;
            display: block;
        }
        .linkrss {
        ...
        .cate-content .viewmore .icon-viewdown {
            margin-bottom: 2px;
        }

        .cate-content .viewmore.less .icon-viewdown {
...
@section('content')
    <div class="body category-page" style="margin-top: 24px">
        <div class="container contain__first">
            <div class="category-page__header flex items-center">
                <h1 style="line-height: 32px;"><span class="category-page__name active">RSS của {{config('siteInfo.site_name')}}</span></h1>
            </div>
        </div>
        <div class="detail-main container flex contain__first">
