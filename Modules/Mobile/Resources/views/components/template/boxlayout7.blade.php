    ...
    <div class="box-category-middle">
        @if(!empty($listNews))
            <div class="swiper video-cate-vtv">
                ...
                <div class="control-magazine-wrap">
                    <div class="wrap-image">
                        <div class="box-control-magazine">
                            <div class="video-cate-vtv-prev">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M28.5 18H7.5" stroke="#292929" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M13.5 12L7.5 18L13.5 24" stroke="#292929" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                            ...
                            <div class="video-cate-vtv-next">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.5 18H28.5" stroke="#292929" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M22.5 12L28.5 18L22.5 24" stroke="#292929" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                        </div>
                    </div>
