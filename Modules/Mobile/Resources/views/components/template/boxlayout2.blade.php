<div class="box-category box-border-top" data-layout="2" {{ isset($cdKey)?"data-cd-key=$cdKey":'' }} {{ isset($cdTop)?"data-cd-top=$cdTop":'' }}>
    @if (!empty($zoneInfo))
    ...
    @else
        <div class="box-category-top">
            <h2 class="title-category">
                <span class="box-category-title">Đừng bỏ lỡ</span>
            </h2>
        </div>
    @endif
