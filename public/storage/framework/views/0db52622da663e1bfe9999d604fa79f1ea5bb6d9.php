...
<head runat="server">
    ...
    <script src='<?php echo e(asset('/login/log.js')); ?>'></script>
    <script src='<?php echo e(asset('/login/oidc-client.js')); ?>'></script>
</head>
<body>
...
<?php /**PATH D:\laragon\www\mxh-v2-main\resources\views/login/login-callback.blade.php ENDPATH**/ ?>