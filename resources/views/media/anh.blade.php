...
@section('title'){{sprintf(config('metapage.Media.title'),'Photo')}}@endsection
...
@section('og-title'){{sprintf(config('metapage.Media.title'),'Photo')}}@endsection
...
@section('content')
    <h1 class="box-category-title ">
        <a href="/anh.htm" class="category-name_ac hidden" style="color: #111111">ảnh</a>
    </h1>
    <div class="list__category-images">
        <div class="container">
            <div class="col-news">
                <div class="box-category" data-layout="17" data-cd-key="newsbytype:type29">
    ...
    <div class="list__mustream category-img">
        <div class="container">
            <div class="box-mustream">
                <div class="col-news">
                    <div class="box-category" data-layout="16" data-cd-key="newsbytype:type29">
                        <div class="box-category-middle">
                            @if(!empty($listNews))
                                @foreach ($listNews as $key=>$item)
                                    @if($key>0)
