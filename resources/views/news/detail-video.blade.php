                        ...
                        <div class="vPlayer">
                            ...
                            @if(!empty($newsContent->VideoMedia))
                                <div class="d-bg-short" id="playOnSite">
                                    <img src="{{!empty($newsContent->VideoMedia->Poster)?UserInterfaceHelper::formatThumbWidth($newsContent->VideoMedia->Poster,true):UserInterfaceHelper::formatThumbWidth($newsContent->Avatar??'',1160,true)}}" alt="image">
                                </div>
