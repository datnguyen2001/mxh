<script type="application/ld+json">
{
    ...
    "@type": "WebSite",
    "name":"{{(!empty($topicInfo->TopicName))?$topicInfo->TopicName:''}}",
    "alternateName": "{{(!empty($topicInfo->MetaDescription))?$topicInfo->MetaDescription:$topicInfo->Description}}",
...
<script type="text/javascript">
    var _ADM_Channel = '%2fchu-de%2f{{$topicInfo->Url??''}}%2f';
</script>
