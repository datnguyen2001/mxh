...
@if(!empty($zoneInfo->ParentShortUrl))
        {
         "@type": "ListItem",
         "position": 2,
         "item": {
...
@endif
    {
        "@type": "ListItem",
        "position": {{!empty($zoneInfo->ParentShortUrl)?3:2}},
        "item": {
...
<script type="text/javascript">
    @if(!empty($zoneInfo->ParentShortUrl))
    var _ADM_Channel = '%2f{{!empty($zoneInfo->ParentShortUrl)?$zoneInfo->ParentShortUrl:$zoneInfo->ShortURL}}%2f{{!empty($zoneInfo->ParentShortUrl)?$zoneInfo->ShortURL:''}}%2f';
    @else
    var _ADM_Channel = '%2f{{$zoneInfo->ShortURL??''}}%2f';
    @endif
</script>
